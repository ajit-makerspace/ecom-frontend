  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex items-center justify-between border-b border-slate-200/80 pb-3">
        ...
        {/* Top 20 Pill Badge */}
        <button className="px-4 py-1 rounded-full border-2 border-[#002740] text-[#002740] font-extrabold text-xs hover:bg-[#002740] hover:text-white transition-colors cursor-pointer shadow-2xs">
          Top 20
        </button>
      </div>
      ...
      <div className="flex items-center justify-center gap-2 pt-2">
        <button
          ...
          className={`h-2.5 rounded-full transition-all cursor-pointer ${
            activePageIndex === 0 ? 'w-8 bg-[#002740]' : 'w-2.5 bg-slate-300 hover:bg-slate-400'
          }`}
        />
        <button
          onClick={() => setActivePageIndex(1)}
          className={`h-2.5 rounded-full transition-all cursor-pointer ${
            activePageIndex === 1 ? 'w-8 bg-[#002740]' : 'w-2.5 bg-slate-300 hover:bg-slate-400'
          }`}
        />
        <button
          onClick={() => setActivePageIndex(2)}
          className={`h-2.5 rounded-full transition-all cursor-pointer ${
            activePageIndex === 2 ? 'w-8 bg-[#002740]' : 'w-2.5 bg-slate-300 hover:bg-slate-400'
          }`}
        />
      </div>
    </div>
