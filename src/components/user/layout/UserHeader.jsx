      ...
      <div className="bg-white border-b border-slate-200/80 text-slate-500 text-xs py-2 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-[11px] font-semibold text-slate-600">
            <Link href="/user/products" className="hover:text-[#002740] transition-colors flex items-center gap-1.5">
            ...
            <Link href="/admin/login" className="hover:text-[#002740] transition-colors flex items-center gap-1.5">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <Link href="/user" className="flex items-center gap-0.5">
              ...
              <span className="w-2.5 h-2.5 rounded-full bg-[#002740] inline-block self-end mb-1.5" />
            </Link>
          ...
          {/* Search Bar with Admin Sidebar Blue (#002740) */}
          <form onSubmit={handleSearchSubmit} className="flex-1 max-w-2xl flex items-center rounded-full border-2 border-[#002740] bg-white overflow-hidden shadow-2xs">
            <input
              type="text"
            ...
            {/* Search Button in Admin Sidebar Blue */}
            <button
              type="submit"
              className="w-11 h-10 bg-[#002740] hover:bg-[#0C3554] text-white font-bold flex items-center justify-center transition-colors cursor-pointer shrink-0 rounded-r-full"
            >
          ...
          <div className="flex items-center gap-5 shrink-0 justify-end">
            <Link href="/user/products" className="relative p-1.5 text-slate-700 hover:text-slate-950 transition-colors">
              ...
              <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-[#002740] text-white font-black text-[9px] flex items-center justify-center">
                0
              </span>
            </Link>
